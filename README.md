...
This repo also contains two attack scenarios which combine my CVE-2020-8791 PoC with methods similar to the CVE-2019-13143 PoC by SecureLayer7 ([pwnfb50.py](https://github.com/securelayer7/pwnfb50/blob/master/pwnfb50.py)).
