...
This repo also contains a discussion of two attack scenarios which could be achieved by combining ownklok PoCs with the CVE-2019-13143 PoC by SecureLayer7 ([pwnfb50.py](https://github.com/securelayer7/pwnfb50/blob/master/pwnfb50.py)).
